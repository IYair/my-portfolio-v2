  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      {featuredProjects.length > 0 && (
        <section className="bg-foreground/5 relative z-20 py-20">
          <div className="mx-auto max-w-6xl px-6">
            <div className="mb-12">
              <h2 className="mb-4 text-3xl font-bold">{t("featured")}</h2>
      ...
      <section className="relative z-20 py-20">
        <div className="mx-auto max-w-6xl px-6">
          <div className="mb-12">
            <h2 className="mb-4 text-3xl font-bold">{t("allProjects")}</h2>
          ...
          {allProjects.length > 0 ? (
            ...
            <div className="border-foreground/10 bg-background rounded-lg border p-12 text-center">
              <p className="text-foreground/60">{t("noProjects")}</p>
            </div>
          )}
        </div>
      </section>
